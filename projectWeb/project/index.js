...
mongoose.connect('mongodb+srv://longNgu:06042000@cluster0.z8p9h.mongodb.net/shop?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
    if (err){
